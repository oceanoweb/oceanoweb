    ...
    <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 py-32 md:py-40">
        <div className="max-w-3xl">
          ...
          <h1
            className="font-heading text-4xl font-bold leading-tight text-foreground md:text-6xl lg:text-7xl animate-slide-up"
          ...
          <div
            className="mt-16 grid grid-cols-3 gap-8 border-t border-border pt-8 animate-slide-up"
