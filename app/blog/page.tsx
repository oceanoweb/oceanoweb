      ...
      <section className="relative border-b border-border py-24 md:py-32">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <h1 className="mt-4 max-w-2xl font-heading text-4xl font-bold text-foreground text-balance md:text-5xl">
            Insights sobre IA, tecnologia e crescimento digital
          </h1>
          <p className="mt-4 max-w-xl text-lg leading-relaxed text-muted-foreground">
            Conteúdo prático para líderes e equipas que querem transformar os seus negócios com
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {blogPosts.map(post => (
              <article
                key={post.slug}
                className="group flex flex-col rounded-2xl border border-border bg-card transition-all duration-300 hover:border-primary/40 hover:bg-secondary"
              >
      ...
      <section className="bg-secondary/30 py-24 md:py-32">
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-lg text-muted-foreground">
            Fale com um especialista e descubra como IA e tecnologia podem impulsionar o seu
            crescimento.
          </p>
